...
This is a implementation of CropMix + MAE, we only apply CropMix to the pre-training stage. 

* The original MAE implementation was in TensorFlow+TPU. This re-implementation is in PyTorch+GPU.
...
### Fine-tuning with pre-trained checkpoints (original MAE)
