    ...
    def __call__(self, x):
        ...
        if self.number ==2 :
            t1 = transforms.Compose([
                transforms.RandomResizedCrop(224, scale=(self.scale, (1-self.scale)/self.number), interpolation =3 ),
                transforms.ToTensor(),
            ])
            t2 = transforms.Compose([
                transforms.RandomResizedCrop(224, scale=(((1-self.scale)/self.number), 1), interpolation =3),
                transforms.ToTensor(),
            ])
            view1 = t1(x)
            view2 = t2(x)
            ...
            t1 = transforms.Compose([
                transforms.RandomResizedCrop(224, scale=(self.scale, self.scale + (1-self.scale)/self.number), interpolation =3),
                transforms.ToTensor(),
            ])
            t2 = transforms.Compose([
                transforms.RandomResizedCrop(224, scale=((self.scale + (1-self.scale)/self.number), (self.scale + 2 * (1-self.scale)/self.number)), interpolation =3),
                transforms.ToTensor(),
            ])
            t3 = transforms.Compose([
                transforms.RandomResizedCrop(224, scale=((self.scale + 2 * (1-self.scale)/self.number), 1), interpolation =3),
                transforms.ToTensor(),
            ])
            ...
            t3 = transforms.Compose([
                transforms.RandomResizedCrop(224, scale=((self.scale + 2* (1-self.scale)/self.number), (self.scale + 3 * (1-self.scale)/self.number)), interpolation =3),
                transforms.ToTensor(),
            ])
            t4 = transforms.Compose([
                transforms.RandomResizedCrop(224, scale=((self.scale + 3 * (1-self.scale)/self.number), 1), interpolation =3),
                transforms.ToTensor(),
            ])
