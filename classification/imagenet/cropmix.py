...
class CropMix:
    ...
    def __call__(self, x):
        ...
        if self.number ==2 :
            ...
            t2 = transforms.Compose([
                transforms.RandomResizedCrop(224, scale=((self.scale + (1-self.scale)/self.number), (self.scale + 2 * (1-self.scale)/self.number))),
                transforms.ToTensor(),
            ])
            ...
            t3 = transforms.Compose([
                transforms.RandomResizedCrop(224, scale=((self.scale + 2* (1-self.scale)/self.number), (self.scale + 3 * (1-self.scale)/self.number))),
                transforms.ToTensor(),
            ])
